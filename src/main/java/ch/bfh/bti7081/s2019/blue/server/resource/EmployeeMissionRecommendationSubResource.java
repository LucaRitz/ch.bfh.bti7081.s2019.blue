...
public class EmployeeMissionRecommendationSubResource {
    ...
    @Autowired
    public EmployeeMissionRecommendationSubResource(EmployeeRepository employeeRepository,
    ...
    List<Mission> find(@PathVariable Integer employeeId,
        ...
        return patientMissionRecommendationService
                .getPatientMissionRecommendations(employee.get(), new DateRange(start, end));
    }
}
